        ...
        <b-card>
          ...
          <b-form>
            ...
            <b-form-group label="Confirm Password:" label-for="re-password">
              <b-form-input type="password" id="re-password" name="re-password" v-validate="'required'" v-model="form.re_password" :class="{ 'is-invalid': errors.has('re-password')}" ></b-form-input>
